...
function demoLiveChat() {
  ...
  var url = "http://localhost:8010/proxy/v1.0/customer/4660/bot/6bc26c50902b4838/flow/26861AAD8AA74064A1B8C8059F7D6363?user.first_name="+firstName+"&country="+userCountry+"&user.last_name="+lastName+"&user.email="+userEmail+"&user.phone_number="+userPhone+"&apiType=lead"+"&company="+userCompany;
  xhttp.open("POST", url, true);
